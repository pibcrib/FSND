...
def paginate_books(lst, request):
...
def create_app(test_config=None):
  ...
  def get_questions():  #DONE
    ...
    current_questions = paginate_books(questions, request)
  ...
  def get_quiz_questions():
    ...
    next_question = Question.query.filter(Question.category == quiz_category_id).filter(Question.id.notin_(previous_questions)).order_by(func.random()).first()
